...
${OBJECTDIR}/_ext/1292091561/binaryTree.o: ../../../ass2files/binaryTree.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1292091561/binaryTree.o ../../../ass2files/binaryTree.cpp

${OBJECTDIR}/_ext/1292091561/skel.o: ../../../ass2files/skel.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1292091561
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1292091561/skel.o ../../../ass2files/skel.cpp

${OBJECTDIR}/_ext/1292091561/sorttest.o: ../../../ass2files/sorttest.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1292091561
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1292091561/sorttest.o ../../../ass2files/sorttest.cpp

${OBJECTDIR}/_ext/1292091561/treeNode.o: ../../../ass2files/treeNode.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1292091561
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1292091561/treeNode.o ../../../ass2files/treeNode.cpp
